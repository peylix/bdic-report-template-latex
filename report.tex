...
% If you prefer a full title page, use the following command
\makenewtitlepage
...
% Or if you prefer a compact title instead, comment out the previous command and use the following command
% \makecompacttitle

% You can also use a combination of the compact title and the table of contents based on your needs
